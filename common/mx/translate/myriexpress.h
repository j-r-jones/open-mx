...
enum mx_return_code { /* FIXME */
	...
	MX_HOST_NOT_FOUND	= OMX_PEER_NOT_FOUND,
	...
	MX_NIC_NOT_FOUND	= OMX_NIC_ID_NOT_FOUND,
	MX_BAD_KERNEL_VERSION	= OMX_BAD_KERNEL_ABI,
	MX_BAD_LIB_VERSION	= OMX_BAD_LIB_ABI,
	MX_NIC_DEAD		= 139, /* useless for Open-MX ? */
	MX_CANCEL_NOT_SUPPORTED	= OMX_BAD_REQUEST,
	MX_CLOSE_IN_HANDLER	= OMX_NOT_SUPPORTED_IN_HANDLER,
	MX_BAD_MATCHING_FOR_CONTEXT_ID_MASK	= OMX_BAD_MATCHING_FOR_CONTEXT_ID_MASK,
	MX_NOT_SUPPORTED_WITH_CONTEXT_ID	= 143, /* useless for Open-MX */
};
