...
struct omx_endpoint {
	...
	unsigned long last_free_exp_eventq_offset;
	unsigned long last_free_unexp_eventq_offset;
	atomic64_t exp_eventq_counter, unexp_eventq_counter, unexp_reserved_counter;
	atomic64_t recvq_counter;
